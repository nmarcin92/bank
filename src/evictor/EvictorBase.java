...
public abstract class EvictorBase implements Ice.ServantLocator {
    ...
    synchronized public final Ice.Object locate(Ice.Current c,
    ...
    synchronized public final void finished(Ice.Current c, Ice.Object o,
    ...
    private evictor.LinkedList<Ice.Identity> _queue = new evictor.LinkedList<Ice.Identity>();
    private int _size;
}